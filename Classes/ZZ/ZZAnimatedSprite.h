...
//@RESOURCE
class AnimationLogic : public Ref
{
protected:
...
//@INSTANCE
class AnimatedSprite : public Sprite, public EventBus
{
protected:

	std::map<std::string, Animation*> m_animations;

	Animate* m_animAction;		//@INSTANCE
	Action* m_animActionSequence; //@INSTANCE

	Animation* m_currAnim;		//@INSTANCE
